...
export function SpinnerLoadingIndicator({ children }: { children: ReactNode }) {
  return (
...
export function BorderLoadingIndicator({
  children,
  className,
}: {
  children: ReactNode;
...
export function NodeStatusIndicator({
  ...
  switch (status) {
    ...
    case "success":
      return (
        <StatusBorder className={cn("border-green-500/50", className)}>
          {children}
        </StatusBorder>
      );
    case "error":
