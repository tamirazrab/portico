    ...
    <Dialog open={Open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Use this webhook URL in your Google Form App Script to trigger this
        ...
        <ScrollArea className="max-h-[calc(100vh-220px)]">
          <div className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="webhook-url" className="pb-2">
                Webhook URL
              </Label>
            ...
            <div className="rounded-lg bg-muted p-4 ">
              ...
              <ol className="text-sm text-muted-foreground space -y-1 list-decimal list-inside">
                ...
                <li>
                  Click on the three dots in the top right corner -→ "Script
                  editor".
                </li>
                <li>In the Script editor, paste the following code:</li>
                <li>
                  Replace "YOUR_WEBHOOK_URL" with the webhook URL you copied
                  earlier.
                </li>
            ...
            <div className="rounded-lg bg-muted p-4 space-y-3">
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    toast.error(
                      "Failed to copy Google Form Script to clipboard",
                    );
                  }
                }}
              >
              ...
              <p className="text-xs text-muted-foreground">
                this contains all the necessary code to trigger this workflow
