                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription className="text-red-500">
                      {!credentials?.length &&
                        "Please add a Anthropic credential"}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      sets the behavior and tone of the assistant.use{" "}
                      {"{{variableName}}"} to reference the variable name.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Prompt to send to the ai.use {"{{variableName}}"} to
