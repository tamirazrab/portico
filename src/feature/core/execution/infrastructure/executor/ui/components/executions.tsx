...
export function ExecutionsList() {
  ...
  return (
    <EntityList<ExecutionWithWorkflow>
...
export function ExecutionItem({ data }: { data: ExecutionWithWorkflow }) {
  const params = useParams();
  const rawLang = params.lang;
  const lang =
    typeof rawLang === "string" && isAppLocale(rawLang)
      ? rawLang
      : defaultLocale();
  ...
  return (
    <EntityItem
      href={routes.execution(lang, data.id)}
