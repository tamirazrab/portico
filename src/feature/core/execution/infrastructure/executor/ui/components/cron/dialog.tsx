...
export function CronTriggerDialog({
  ...
  const { data: credentials } = useCredentialsByType(CredentialType.CRON);
      ...
      <DialogContent>
        ...
        <ScrollArea className="max-h-[calc(100vh-200px)]">
          ...
          <div className="space-y-2 p-2">
            <Label htmlFor="webhook-url" className="p-2">
              You can use the below URL to create custom cron
            </Label>
          ...
          <div className="rounded-lg bg-muted p-4 ">
            ...
            <ol className="text-sm text-muted-foreground space -y-1 list-decimal list-inside">
              ...
              <li>
                Use the above webhook URL as the target URL for your custom cron
                job
              </li>
            </ol>
          </div>
        ...
        <DialogFooter>
          ...
          <Button form="cron-trigger-form" type="submit">
            Save
          </Button>
        </DialogFooter>
      </DialogContent>
